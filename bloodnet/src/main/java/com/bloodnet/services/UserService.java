...
public class UserService extends BaseService {
	 ...
	 */
	public void createUser(final String userId, final String password, final String profileId, final String secondaryEmail) {
		...
		restTemplate.postForObject("http://localhost:8080/api/users", formEntity, String.class);
	}
}
